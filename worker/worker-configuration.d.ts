/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b8d93b413a95654e5d6c8df1b85b1187)
// Runtime types generated with workerd@1.20260730.1 2026-01-01 nodejs_compat
interface __BaseEnv_Env {
	...
	SESSION: DurableObjectNamespace<import("./src/index").SessionRoom>;
	CHALLENGE: DurableObjectNamespace<import("./src/index").AuthChallenge>;
	RL_GLOBAL: RateLimit;
	RL_AUTH: RateLimit;
	RL_LOOKUP: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SessionRoom" | "AuthChallenge";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RP_ID" | "RP_ORIGIN" | "JWT_SECRET" | "SETUP_SECRET" | "CLOUDFLARE_TURN_KEY_ID" | "CLOUDFLARE_TURN_API_TOKEN" | "CLOUDFLARE_TURN_TTL_SECONDS">> {}
}
